  ...
  return (
    <div className="min-h-screen bg-paper text-ink relative">
      ...
      <article className="max-w-4xl mx-auto px-6 pt-16 pb-8">
        <header className="mb-10"><h1 className="font-heading text-4xl md:text-5xl font-bold text-ink leading-tight mb-4">
        ...
        <section className="mb-10 bg-surface  rounded-xl border border-line p-7">
          <h2 className="font-heading text-2xl font-bold text-ink mb-4">The Story Behind GlobalSync AI</h2>
          <p className="text-quiet leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="font-heading text-2xl font-bold text-ink mb-6">Our Suite of Free AI-Powered Productivity Tools</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              const styles = {
                blue: { borderHover: "hover:border-line", bg: "bg-gem-sage/10", text: "text-quiet" },
                emerald: { borderHover: "hover:border-line", bg: "bg-gem-gold/10", text: "text-pine" },
                orange: { borderHover: "hover:border-gem-mist/30", bg: "bg-gem-mist/10", text: "text-quiet" }
              }[color];
              return (
                <Link key={title} to={link} className={`bg-surface  rounded-xl border border-line p-5 ${styles.borderHover} hover:bg-surface transition-all`}>
                  <div className={`w-10 h-10 ${styles.bg} rounded-xl flex items-center justify-center mb-3`}>
                    <Icon className={`w-5 h-5 ${styles.text}`} />
                  </div>
                  <h3 className="font-semibold text-ink mb-2">{title}</h3>
                  <p className="text-sm text-quiet leading-relaxed">{desc}</p>
                </Link>
              );
            })}
          </div>
        ...
        <section className="mb-10 bg-surface  rounded-xl border border-line p-7">
          <h2 className="font-heading text-2xl font-bold text-ink mb-4">How GlobalSync AI Makes Money</h2>
          <p className="text-quiet leading-relaxed mb-4">
        ...
        <section className="mb-10 bg-surface  rounded-xl border border-line p-7">
          <h2 className="font-heading text-2xl font-bold text-ink mb-6">Meet the Creator & Remote Engineering Community</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex gap-4">
              ...
              />
              <div className="hidden w-14 h-14 bg-gem-gold/20 text-pine rounded-full items-center justify-center font-bold text-xl shrink-0">
                AH
              </div>
              <div>
                <h3 className="font-semibold text-ink">Ahmed Hussain</h3>
                <div className="text-sm text-pine mb-2">Founder & Developer</div>
                <p className="text-sm text-quiet leading-relaxed mb-2">
            ...
            <div className="flex gap-4">
              <div className="w-14 h-14 bg-gem-gold/20 text-pine rounded-full flex items-center justify-center font-bold text-xl shrink-0">
                GC
              </div>
              <div>
                <h3 className="font-semibold text-ink">Global Contributors</h3>
                <div className="text-sm text-pine mb-2">The Remote Community</div>
        ...
        <section className="mb-10 bg-surface  rounded-xl border border-line p-7">
          <h2 className="font-heading text-2xl font-bold text-ink mb-4">Our Data Sources</h2>
          <p className="text-quiet leading-relaxed mb-4">
            ...
            {[
              ...
              <li key={source} className="flex gap-3">
                ...
                <div>
                  ...
                  <span className="text-quiet text-sm">{desc}</span>
                </div>
              </li>
            ))}
          </ul>
        ...
        <section className="mb-10 bg-surface  rounded-xl border border-line p-7">
          <h2 className="font-heading text-2xl font-bold text-ink mb-4">Who is GlobalSync AI For?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item} className="flex items-start gap-2 text-sm text-quiet">
                <Zap className="w-3.5 h-3.5 text-pine mt-0.5 shrink-0" />
                {item}
              </div>
            ))}
          </div>
        ...
        <section className="bg-wash rounded-2xl border border-line p-7">
          <h2 className="font-heading text-xl font-bold text-ink mb-2">Get in Touch with Our Support Team</h2>
          <p className="text-quiet text-sm mb-4">Questions, feedback, or partnership enquiries? We'd love to hear from you.</p>
          <Link to="/contact" className="inline-flex items-center gap-2 bg-pine text-paper font-bold rounded-xl px-5 py-2.5 text-sm hover:opacity-90 transition-all">
