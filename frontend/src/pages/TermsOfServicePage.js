    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <nav className="max-w-3xl mx-auto px-6 pt-6 pb-2">
        <ol className="flex items-center gap-2 text-sm text-zinc-400">
          ...
          <span>/</span>
          <li><span className="text-zinc-600 font-medium">Terms of Service</span></li>
        </ol>
      </nav>

      <article className="max-w-3xl mx-auto px-6 py-8">
        <header className="mb-8">
          <h1 className="font-heading text-4xl font-bold text-zinc-900 mb-3">Terms of Service</h1>
          <p className="text-sm text-zinc-400">Last updated: {LAST_UPDATED}</p>
        </header>

        <div className="bg-zinc-50 rounded-xl border border-zinc-200 p-4 mb-8 text-sm text-zinc-700">
          <strong>Please read these Terms carefully.</strong> By using GlobalSync AI, you agree to be bound by these Terms. If you do not agree, please do not use our services.
        </div>

        <div className="space-y-8 text-zinc-600 leading-relaxed">
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">1. Acceptance of Terms</h2>
            <p>By accessing or using GlobalSync AI at <strong>globalsync-ai.com</strong> (the "Service"), you agree to be bound by these Terms of Service ("Terms"). These Terms apply to all visitors, users, and others who access the Service.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">3. Accuracy of Information</h2>
            <p>GlobalSync AI provides conversion tools for informational purposes only. While we strive to ensure accuracy:</p>
            <ul className="list-disc pl-5 space-y-1 text-sm mt-2">
              <li><strong>Exchange rates</strong> are sourced from third-party APIs and may not reflect real-time market rates or the rates offered by banks and financial institutions.</li>
              <li><strong>Time zone data</strong> relies on the IANA Time Zone Database and may not account for recent government changes to daylight saving time rules.</li>
              <li><strong>We are not responsible</strong> for any financial, legal, or business decisions made based on information provided by this Service.</li>
            </ul>
            <p className="mt-3">Always verify critical information with official sources before making financial or legal decisions.</p>
          </section>

          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">5. Intellectual Property</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">6. Third-Party Services</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">7. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">8. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">9. Rate Limiting</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">10. Changes to Terms</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-zinc-900 mb-3">11. Contact</h2>
            <p>If you have questions about these Terms, please contact us at <a href="mailto:hello@globalsync-ai.com" className="text-blue-600 hover:underline">hello@globalsync-ai.com</a>.</p>
          </section>
        </div>
      </article>
