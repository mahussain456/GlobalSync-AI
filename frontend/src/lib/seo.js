...
export const getCurrencyHubSEO = () => ({
  ...
  description: `Convert 160+ currencies with live mid-market exchange rates. USD to INR, EUR to GBP, PKR, NGN, and more. Real-time, accurate, and completely free.`,
...
export const getMeetingPlannerSEO = () => ({
  ...
  description: `Find the best meeting time across multiple cities. Instantly see business hour overlaps and schedule global team calls without off-hour conflicts. Free.`,
...
export const getBlogIndexSEO = () => ({
  rawTitle: `Remote Work, Time Zones & Currency Blog | ${BRAND}`,
